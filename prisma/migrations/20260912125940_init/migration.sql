...
CREATE TABLE "Project" (
    ...
    "techList" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "github" TEXT,
    "liveUrl" TEXT,
...
-- CreateIndex
CREATE INDEX "AboutParagraph_sortOrder_idx" ON "AboutParagraph"("sortOrder");
...
-- CreateIndex
CREATE INDEX "Technology_category_sortOrder_idx" ON "Technology"("category", "sortOrder");

-- CreateIndex
CREATE INDEX "Skill_sortOrder_idx" ON "Skill"("sortOrder");

-- CreateIndex
CREATE INDEX "Interest_sortOrder_idx" ON "Interest"("sortOrder");
